        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowsTests = table.Column<bool>(type: "bit", nullable: false),
                    PriceCredits = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InstructorSubscriptions_AspNetUsers_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_Courses_RelatedCourseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentAnswers_TestAttempts_AttemptId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AllowsTests", "Code", "CommissionPercent", "MaxCourses", "PriceCredits" },
                values: new object[,]
                {
                    { 1, false, 0, 30m, 3, 0m },
                    { 2, true, 1, 20m, 10, 100m },
                    { 3, true, 2, 10m, null, 300m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_RelatedCourseId",
                table: "Transactions",
